...
"    %2 = call @__torch__._movedim(%arg0, %0, %1) : (!torch.list<int>, !torch.list<int>, !torch.list<int>) -> !torch.list<int>\n"
"    %3 = call @__torch__.torch.jit._shape_functions.permute(%arg0, %2) : (!torch.list<int>, !torch.list<int>) -> !torch.list<int>\n"
"    return %3 : !torch.list<int>\n"
"  }\n"
"  func.func @__torch__._movedim(%arg0: !torch.list<int>, %arg1: !torch.list<int>, %arg2: !torch.list<int>) -> !torch.list<int> {\n"
"    %int-1 = torch.constant.int -1\n"
"    %true = torch.constant.bool true\n"
"    %int0 = torch.constant.int 0\n"
"    %0 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
...
"      torch.prim.Loop %5, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.__getitem__.t %arg1, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %17 = func.call @__torch__.torch.jit._shape_functions.maybe_wrap_dim(%16, %0, %true) : (!torch.int, !torch.int, !torch.bool) -> !torch.int\n"
"        %18 = torch.aten.append.t %3, %17 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        %19 = torch.aten.__getitem__.t %arg2, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %20 = func.call @__torch__.torch.jit._shape_functions.maybe_wrap_dim(%19, %0, %true) : (!torch.int, !torch.int, !torch.bool) -> !torch.int\n"
"        %21 = torch.aten.append.t %4, %20 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      %6 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"      torch.prim.Loop %0, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.append.t %6, %int-1 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      %7 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"      torch.prim.Loop %0, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.append.t %7, %arg3 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      %8 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"      torch.prim.Loop %0, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.append.t %8, %arg3 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      %9 = torch.aten.len.t %arg1 : !torch.list<int> -> !torch.int\n"
"      torch.prim.Loop %9, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.__getitem__.t %3, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %17 = torch.aten.__getitem__.t %4, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %18 = torch.aten._set_item.t %6, %17, %16 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"        %19 = torch.aten.__getitem__.t %3, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %20 = torch.aten._set_item.t %7, %19, %int-1 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"        %21 = torch.aten.__getitem__.t %4, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %22 = torch.aten._set_item.t %8, %21, %int-1 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      %10 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"      %11 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
...
"      torch.prim.Loop %12, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.__getitem__.t %7, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %17 = torch.aten.ne.int %16, %int-1 : !torch.int, !torch.int -> !torch.bool\n"
"        torch.prim.If %17 -> () {\n"
"          %18 = torch.aten.append.t %10, %16 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"          torch.prim.If.yield\n"
"        } else {\n"
"          torch.prim.If.yield\n"
"        }\n"
...
"      torch.prim.Loop %13, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.__getitem__.t %8, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %17 = torch.aten.ne.int %16, %int-1 : !torch.int, !torch.int -> !torch.bool\n"
"        torch.prim.If %17 -> () {\n"
"          %18 = torch.aten.append.t %11, %16 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"          torch.prim.If.yield\n"
"        } else {\n"
"          torch.prim.If.yield\n"
"        }\n"
...
"      torch.prim.Loop %15, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %16 = torch.aten.__getitem__.t %10, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %17 = torch.aten.__getitem__.t %11, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %18 = torch.aten._set_item.t %6, %17, %16 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      torch.prim.If.yield %6 : !torch.list<int>\n"
...
"    return %2 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.movedim.int\"(%arg0: !torch.int, %arg1: !torch.int, %arg2: !torch.int, %arg3: !torch.int) -> !torch.int {\n"
