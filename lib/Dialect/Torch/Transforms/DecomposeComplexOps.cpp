...
public:
  ...
  LogicalResult matchAndRewrite(AtenConvolutionBackwardOp op,
    ...
    BaseTensorType gradWeightTy =
        inputTransposedTy
            .getWithSizesAndDtype(llvm::makeArrayRef(gradWeightSizesInt),
    ...
    SmallVector<Value, 5> gradWeightViewShape;
    gradWeightViewShape.push_back(
        rewriter.create<Torch::AtenSizeIntOp>(loc, inputTransposed, cstZero));
    gradWeightViewShape.push_back(
        rewriter.create<Torch::AtenSizeIntOp>(loc, inputTransposed, cstOne));
    gradWeightViewShape.push_back(gradOutputSize[1]);
    gradWeightViewShape.push_back(
        rewriter.create<Torch::AtenSizeIntOp>(loc, gradWeight, cstTwo));
    gradWeightViewShape.push_back(
        rewriter.create<Torch::AtenSizeIntOp>(loc, gradWeight, cstThree));
    ...
    BaseTensorType gradWeightTypeForView =
        gradWeightTy
            .getWithSizesAndDtype(llvm::makeArrayRef(gradWeightViewShapeInt),
                                  gradWeightTy.getOptionalDtype())
            .cast<BaseTensorType>();
    ...
    SmallVector<int64_t, 5> gradWeightDimsOrder = computeDimsOrderForMoveDim(
        llvm::makeArrayRef({(int64_t)0}), llvm::makeArrayRef({(int64_t)2}),
        gradWeightViewShapeInt.size());
    ...
    BaseTensorType gradWeightTypeForMoveDim =
        gradWeightTy
            .getWithSizesAndDtype(llvm::makeArrayRef(gradWeightMoveDimShape),
                                  gradWeightTy.getOptionalDtype())
            .cast<BaseTensorType>();
